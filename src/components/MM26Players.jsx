          ...
          <table className="compare-table table-fixed w-full text-xs border-collapse text-center sm:text-sm">
            <thead>
              <tr className={theme === "dark" ? "bg-gray-700" : "bg-gray-200"}>
                <th className={`compare-label-cell w-[18%] border px-1 py-1 ${theme === "dark" ? "border-gray-600" : "border-gray-300"}`}>
                  Stat
                </th>
            ...
            <thead>
              <Droppable droppableId="players" direction="horizontal">
                {(provided) => (
                  ...
                  >
                    <th className={`compare-label-cell sticky left-0 z-10 w-[18%] border px-1 py-2 sm:px-4 ${
